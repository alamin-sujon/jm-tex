...
export default function Footer() {
  ...
  return (
    <footer className="bg-black/90 text-white  py-8 md:py-20  md:px-10 lg:px-16">
      <div className="flex flex-col max-w-7xl mx-auto lg:flex-row justify-between border-b border-gray-300  mb-8 px-6">
        <div className="w-full lg:w-2/3 mx-auto pb-10">
          <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-1   ">
            ...
            <div>
              ...
              <p className="text-base leading-relaxed  mb-2 pr-3">
                <MdLocationPin size={18} className="inline" /> House 36, Road
                10, Sector 04, <br /> Uttara, Dhaka, Bangladesh.
              </p>
              <p className="text-base mb-2">
                {" "}
                <MdPhone size={18} className="inline" /> +880 1621-027853{" "}
              </p>
              <p className="text-base mb-4">
                {" "}
                <MdEmail size={18} className="inline" />{" "}
            ...
            <div>
              ...
              <ul className="space-y-2 ">
                {allProducts.map((el) => (
                  <li key={el.id} className="hover:underline uppercase">
        ...
        <div className="lg:w-1/3 lg:pl-8 pb-5 lg:border-l border-gray-300 ">
          ...
          <div className="mt-4 flex items-center lg:justify-start gap-4 text-white pr-6">
            ...
            <Link
              href={"https://www.linkedin.com/company/jmtexdesign/"}
              target="_blank"
              className="p-1 bg-gray-800 border rounded-md hover:bg-white hover:text-black transition-all duration-300"
            >
              {" "}
      ...
      <div className="mt-6 max-w-7xl mx-auto px-6  text-sm md:text-base text-white">
        <p className="text-2xl font-semibold">© JM Tex Desig</p>
        <p>Global Sourcing Partner for Fancy Yarns & Apparel</p>
        <p></p>
        <div className="text-sm text-gray-200 mt-2 flex flex-col md:flex-row justify-between items-center gap-2">
          <p>
            All Rights Reserved. | Connecting Bangladesh & Hong Kong to the
            World.
          </p>
