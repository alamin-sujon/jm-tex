      ...
      <header className={`fixed top-0 inset-x-0 z-50 transition-all ${diff}`}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="h-20 flex items-center justify-between">
            {/* Logo */}
            <div className="relative z-30 top-3">
              <Link href="/">
                <Image
                  src={logo}
                  alt="Apparel Trade Logo"
                  width={72} // adjust to your desired size
                  height={72}
                  className="h-16 w-16 md:h-20 md:w-20 border-2 border-orange-500 rounded-full object-cover"
                  priority // good for navbar logo
                />
              </Link>
            </div>
                      ...
                      >
                        ...
                        <div className="border-t border-slate-200 px-8 py-5 flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-3">
                            <Link
                              href={"https://www.facebook.com/jmtexdesign"}
                              target="_blank"
                              className="p-1 bg-gray-800 border text-white rounded-md hover:bg-white hover:text-black transition-all duration-300"
                            >
                              <FaFacebookF size={26} />
                            </Link>
                            <Link
                              href={
                                "https://www.linkedin.com/company/jmtexdesign/"
                              }
                              target="_blank"
                              className="p-1 bg-gray-800 text-white border rounded-md hover:bg-white hover:text-black transition-all duration-300"
                            >
                              {" "}
                              <FaLinkedin size={26} />
                            </Link>
          ...
          <div className="h-20 px-4 flex items-center justify-between border-b">
            <div className="text-lg font-bold">
              <Image
                src={logo}
                alt="JM Tex Logo"
                className="h-16 w-16 rounded-full border border-orange-500"
              />
            </div>
            <button
