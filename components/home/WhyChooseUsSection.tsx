      ...
      <section className="w-full bg-[#F4F6F6] py-24">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="mt-6 text-[15px] leading-7 text-zinc-600">
            Contact JM Tex Design today to discuss your fancy yarn and apparel
            sourcing requirements and explore how our Bangladesh–Hong Kong
            sourcing expertise can support your business growth.
          </p>
